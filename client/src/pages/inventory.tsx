...
export default function Inventory() {
  ...
  const filteredAndSortedProducts = products.filter(product => {
    // فلترة حسب المورد
    if (filterBySupplier !== "all" && product.supplierId !== filterBySupplier) {
      return false;
    }
    return true;
  }).sort((a, b) => {
            ...
            <div className="flex items-center gap-4">
              ...
              <Select value={filterBySupplier} onValueChange={setFilterBySupplier}>
                <SelectTrigger className="w-48">
                  ...
                  <SelectValue placeholder="فلتر حسب المورد" />
                </SelectTrigger>
                <SelectContent>
              ...
              <Select value={sortBy} onValueChange={setSortBy}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="quantity-high">الكمية (الأكثر أولاً)</SelectItem>
                  <SelectItem value="quantity-low">الكمية (الأقل أولاً)</SelectItem>
                </SelectContent>
              </Select>
            </div>
